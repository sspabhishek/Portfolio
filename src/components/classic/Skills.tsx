            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="skills-container grid grid-cols-1 md:grid-cols-2 gap-8">
                    {skillCategories.map((category) => (
                        <div
                            key={category.title}
                            className="skill-category rounded-card p-6 md:p-8 theme-transition glass opacity-0"
                        >
                            <h3
                            ...
                            <div className="flex flex-wrap gap-3">
                                {category.skills.map((skill) => (
                                    <span
                                        key={skill}
                                        className="skill-tag px-4 py-2 rounded-full text-sm font-medium theme-transition cursor-default opacity-0"
                                        style={{
