    ...
    subSections: [
      {
        ...
        problems: [
          { id: 'dp1', name: 'Climbing Stairs', difficulty: 'Easy', leetcodeLink: lc('climbing-stairs') },
          ...
          { id: 'dp4', name: 'Maximum Sum of Non-Adjacent Elements', difficulty: 'Medium', leetcodeLink: lc('house-robber') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'dp7', name: 'Grid Unique Paths', difficulty: 'Medium', leetcodeLink: lc('unique-paths') },
          { id: 'dp8', name: 'Unique Paths II', difficulty: 'Medium', leetcodeLink: lc('unique-paths-ii') },
          { id: 'dp9', name: 'Minimum Path Sum', difficulty: 'Medium', leetcodeLink: lc('minimum-path-sum') },
          { id: 'dp10', name: 'Triangle (Minimum Path Sum)', difficulty: 'Medium', leetcodeLink: lc('triangle') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'dp14', name: 'Partition Equal Subset Sum', difficulty: 'Medium', leetcodeLink: lc('partition-equal-subset-sum') },
          ...
          { id: 'dp19', name: 'Coin Change', difficulty: 'Medium', leetcodeLink: lc('coin-change') },
          { id: 'dp20', name: 'Target Sum', difficulty: 'Medium', leetcodeLink: lc('target-sum') },
          { id: 'dp21', name: 'Coin Change II', difficulty: 'Medium', leetcodeLink: lc('coin-change-ii') },
      ...
      },
      {
        title: 'DP on Strings',
        problems: [
          { id: 'dp24', name: 'Longest Common Subsequence', difficulty: 'Medium', leetcodeLink: lc('longest-common-subsequence') },
          ...
          { id: 'dp27', name: 'Longest Palindromic Subsequence', difficulty: 'Medium', leetcodeLink: lc('longest-palindromic-subsequence') },
          ...
          { id: 'dp30', name: 'Shortest Common Supersequence', difficulty: 'Hard', leetcodeLink: lc('shortest-common-supersequence') },
          { id: 'dp31', name: 'Distinct Subsequences', difficulty: 'Hard', leetcodeLink: lc('distinct-subsequences') },
          { id: 'dp32', name: 'Edit Distance', difficulty: 'Medium', leetcodeLink: lc('edit-distance') },
          { id: 'dp33', name: 'Wildcard Matching', difficulty: 'Hard', leetcodeLink: lc('wildcard-matching') },
        ],
      },
      {
        title: 'DP on Stocks',
        problems: [
          { id: 'dp34', name: 'Best Time to Buy and Sell Stock', difficulty: 'Easy', leetcodeLink: lc('best-time-to-buy-and-sell-stock') },
          { id: 'dp35', name: 'Buy and Sell Stock II', difficulty: 'Medium', leetcodeLink: lc('best-time-to-buy-and-sell-stock-ii') },
      ...
      },
      {
        title: 'DP on LIS',
        problems: [
          { id: 'dp40', name: 'Longest Increasing Subsequence', difficulty: 'Medium', leetcodeLink: lc('longest-increasing-subsequence') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'dp48', name: 'Burst Balloons', difficulty: 'Hard', leetcodeLink: lc('burst-balloons') },
          { id: 'dp49', name: 'Evaluate Boolean Expression to True', difficulty: 'Hard', gfgLink: gfg('boolean-parenthesization5610') },
          { id: 'dp50', name: 'Palindrome Partitioning II', difficulty: 'Hard', leetcodeLink: lc('palindrome-partitioning-ii') },
      ...
      },
      {
        ...
        problems: [
          { id: 'dp52', name: 'Maximal Rectangle', difficulty: 'Hard', leetcodeLink: lc('maximal-rectangle') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'dp55', name: 'Word Break', difficulty: 'Medium', leetcodeLink: lc('word-break') },
    ...
    subSections: [
      {
        ...
        problems: [
          { id: 'tr1', name: 'Implement Trie (Prefix Tree)', difficulty: 'Medium', leetcodeLink: lc('implement-trie-prefix-tree') },
    ...
    subSections: [
      {
        ...
        problems: [
          ...
          { id: 'sa2', name: 'Count and Say', difficulty: 'Medium', leetcodeLink: lc('count-and-say') },
          ...
          { id: 'sa5', name: 'KMP Algorithm', difficulty: 'Hard', leetcodeLink: lc('find-the-index-of-the-first-occurrence-in-a-string') },
          ...
          { id: 'sa8', name: 'Count Palindromic Subsequences', difficulty: 'Hard', leetcodeLink: lc('count-different-palindromic-subsequences') },
          { id: 'sa9', name: 'Repeated String Match', difficulty: 'Medium', leetcodeLink: lc('repeated-string-match') },
        ],
      },
    ],
  },
