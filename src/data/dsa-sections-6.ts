    ...
    subSections: [
      {
        ...
        problems: [
          { id: 'bst1', name: 'Search in BST', difficulty: 'Easy', leetcodeLink: lc('search-in-a-binary-search-tree'), gfgLink: gfg('search-a-node-in-bst') },
          ...
          { id: 'bst4', name: 'Insert a Node in BST', difficulty: 'Medium', leetcodeLink: lc('insert-into-a-binary-search-tree'), gfgLink: gfg('insert-a-node-in-a-bst') },
          { id: 'bst5', name: 'Delete a Node in BST', difficulty: 'Medium', leetcodeLink: lc('delete-node-in-a-bst'), gfgLink: gfg('delete-a-node-from-bst') },
          { id: 'bst6', name: 'Kth Smallest/Largest Element in BST', difficulty: 'Medium', leetcodeLink: lc('kth-smallest-element-in-a-bst'), gfgLink: gfg('find-k-th-smallest-element-in-bst') },
          { id: 'bst7', name: 'Check if a Tree is BST', difficulty: 'Medium', leetcodeLink: lc('validate-binary-search-tree'), gfgLink: gfg('check-for-bst') },
          { id: 'bst8', name: 'LCA in BST', difficulty: 'Medium', leetcodeLink: lc('lowest-common-ancestor-of-a-binary-search-tree'), gfgLink: gfg('lowest-common-ancestor-in-a-bst') },
          { id: 'bst9', name: 'Construct BST from Preorder', difficulty: 'Medium', leetcodeLink: lc('construct-binary-search-tree-from-preorder-traversal'), gfgLink: gfg('preorder-to-postorder4423') },
          ...
          { id: 'bst12', name: 'Two Sum in BST', difficulty: 'Easy', leetcodeLink: lc('two-sum-iv-input-is-a-bst'), gfgLink: gfg('find-a-pair-with-given-target-in-bst') },
          { id: 'bst13', name: 'Recover BST', difficulty: 'Medium', leetcodeLink: lc('recover-binary-search-tree'), gfgLink: gfg('fixed-two-nodes-of-a-bst') },
          ...
          { id: 'bst16', name: 'Convert Sorted Array to BST', difficulty: 'Easy', leetcodeLink: lc('convert-sorted-array-to-binary-search-tree'), gfgLink: gfg('array-to-bst4443') },
        ],
      },
    ],
  },
    ...
    subSections: [
      {
        ...
        problems: [
          ...
          { id: 'g7', name: 'Flood Fill', difficulty: 'Easy', leetcodeLink: lc('flood-fill'), gfgLink: gfg('flood-fill-algorithm1856') },
          ...
          { id: 'g10', name: '0/1 Matrix (Nearest Cell)', difficulty: 'Medium', leetcodeLink: lc('01-matrix'), gfgLink: gfg('distance-of-nearest-cell-having-1-1587115620') },
          { id: 'g11', name: 'Surrounded Regions', difficulty: 'Medium', leetcodeLink: lc('surrounded-regions'), gfgLink: gfg('replace-os-with-xs0052') },
          { id: 'g12', name: 'Number of Enclaves', difficulty: 'Medium', leetcodeLink: lc('number-of-enclaves'), gfgLink: gfg('number-of-enclaves') },
          { id: 'g13', name: 'Word Ladder I', difficulty: 'Hard', leetcodeLink: lc('word-ladder'), gfgLink: gfg('word-ladder') },
          ...
          { id: 'g16', name: 'Bipartite Graph (BFS)', difficulty: 'Medium', leetcodeLink: lc('is-graph-bipartite'), gfgLink: gfg('bipartite-graph') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'g21', name: 'Course Schedule I', difficulty: 'Medium', leetcodeLink: lc('course-schedule'), gfgLink: gfg('course-schedule') },
          { id: 'g22', name: 'Course Schedule II', difficulty: 'Medium', leetcodeLink: lc('course-schedule-ii') },
          { id: 'g23', name: 'Find Eventual Safe States', difficulty: 'Medium', leetcodeLink: lc('find-eventual-safe-states'), gfgLink: gfg('eventual-safe-states') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'g28', name: 'Shortest Path in Binary Maze', difficulty: 'Medium', leetcodeLink: lc('shortest-path-in-binary-matrix'), gfgLink: gfg('shortest-path-in-a-binary-maze-1655453161') },
          { id: 'g29', name: 'Path with Minimum Effort', difficulty: 'Medium', leetcodeLink: lc('path-with-minimum-effort') },
          { id: 'g30', name: 'Cheapest Flights within K Stops', difficulty: 'Medium', leetcodeLink: lc('cheapest-flights-within-k-stops'), gfgLink: gfg('cheapest-flights-within-k-stops') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'g41', name: 'Accounts Merge', difficulty: 'Medium', leetcodeLink: lc('accounts-merge'), gfgLink: gfg('account-merge') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'g49', name: 'Number of Islands', difficulty: 'Medium', leetcodeLink: lc('number-of-islands'), gfgLink: gfg('find-the-number-of-islands') },
          { id: 'g50', name: 'Pacific Atlantic Water Flow', difficulty: 'Medium', leetcodeLink: lc('pacific-atlantic-water-flow') },
          { id: 'g51', name: 'Clone Graph', difficulty: 'Medium', leetcodeLink: lc('clone-graph'), gfgLink: gfg('clone-graph') },
