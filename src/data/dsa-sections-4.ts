    ...
    subSections: [
      {
        ...
        problems: [
          ...
          { id: 'bit4', name: 'Check if a Number is Power of 2', difficulty: 'Easy', leetcodeLink: lc('power-of-two') },
      ...
      },
      {
        ...
        problems: [
          { id: 'bit9', name: 'Count Number of Set Bits', difficulty: 'Easy', leetcodeLink: lc('counting-bits') },
          { id: 'bit10', name: 'Power Set', difficulty: 'Medium', leetcodeLink: lc('subsets'), gfgLink: gfg('power-set4302') },
          { id: 'bit11', name: 'Single Number I', difficulty: 'Easy', leetcodeLink: lc('single-number') },
          { id: 'bit12', name: 'Single Number II', difficulty: 'Medium', leetcodeLink: lc('single-number-ii') },
          { id: 'bit13', name: 'Single Number III', difficulty: 'Medium', leetcodeLink: lc('single-number-iii') },
    ...
    subSections: [
      {
        ...
        problems: [
          ...
          { id: 'sq3', name: 'Implement Stack using Queue', difficulty: 'Medium', leetcodeLink: lc('implement-stack-using-queues') },
          { id: 'sq4', name: 'Implement Queue using Stack', difficulty: 'Medium', leetcodeLink: lc('implement-queue-using-stacks') },
          ...
          { id: 'sq8', name: 'Implement Min Stack', difficulty: 'Medium', leetcodeLink: lc('min-stack') },
        ],
      },
      {
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'sq29', name: 'LRU Cache', difficulty: 'Hard', leetcodeLink: lc('lru-cache') },
    ...
    subSections: [
      {
        ...
        problems: [
          { id: 'sw1', name: 'Longest Substring Without Repeating Characters', difficulty: 'Medium', leetcodeLink: lc('longest-substring-without-repeating-characters') },
          { id: 'sw2', name: 'Max Consecutive Ones III', difficulty: 'Medium', leetcodeLink: lc('max-consecutive-ones-iii') },
          { id: 'sw3', name: 'Fruit Into Baskets', difficulty: 'Medium', leetcodeLink: lc('fruit-into-baskets') },
