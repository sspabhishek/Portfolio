...
export const dsaSections5: DSASection[] = [
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        problems: [
          { id: 'hp5', name: 'Kth Largest Element', difficulty: 'Medium', leetcodeLink: lc('kth-largest-element-in-an-array'), gfgLink: gfg('kth-largest-element-in-an-array') },
          ...
          { id: 'hp9', name: 'Top K Frequent Elements', difficulty: 'Medium', leetcodeLink: lc('top-k-frequent-elements'), gfgLink: gfg('top-k-frequent-elements-in-array') },
      ...
      },
      {
        title: 'Hard Problems',
        problems: [
          { id: 'hp12', name: 'Merge K Sorted Lists', difficulty: 'Hard', leetcodeLink: lc('merge-k-sorted-lists'), gfgLink: gfg('merge-k-sorted-linked-lists') },
          ...
          { id: 'hp15', name: 'Find Median from Data Stream', difficulty: 'Hard', leetcodeLink: lc('find-median-from-data-stream'), gfgLink: gfg('find-median-in-a-stream-1587115620') },
    ...
    subSections: [
      {
        title: 'Easy Problems',
        problems: [
          { id: 'gr1', name: 'Assign Cookies', difficulty: 'Easy', leetcodeLink: lc('assign-cookies'), gfgLink: gfg('assign-cookies') },
          ...
          { id: 'gr4', name: 'Lemonade Change', difficulty: 'Easy', leetcodeLink: lc('lemonade-change'), gfgLink: gfg('lemonade-change') },
      ...
      },
      {
        ...
        problems: [
          ...
          { id: 'gr7', name: 'Jump Game', difficulty: 'Medium', leetcodeLink: lc('jump-game'), gfgLink: gfg('jump-game') },
          ...
          { id: 'gr14', name: 'Insert Interval', difficulty: 'Medium', leetcodeLink: lc('insert-interval'), gfgLink: gfg('insert-interval-1666733333') },
          { id: 'gr15', name: 'Merge Intervals', difficulty: 'Medium', leetcodeLink: lc('merge-intervals'), gfgLink: gfg('overlapping-intervals') },
    ...
    subSections: [
      {
        ...
        problems: [
          ...
          { id: 'bt4', name: 'Preorder Traversal', difficulty: 'Easy', leetcodeLink: lc('binary-tree-preorder-traversal'), gfgLink: gfg('preorder-traversal') },
          { id: 'bt5', name: 'Inorder Traversal', difficulty: 'Easy', leetcodeLink: lc('binary-tree-inorder-traversal'), gfgLink: gfg('inorder-traversal') },
          { id: 'bt6', name: 'Postorder Traversal', difficulty: 'Easy', leetcodeLink: lc('binary-tree-postorder-traversal'), gfgLink: gfg('postorder-traversal') },
          { id: 'bt7', name: 'Level Order Traversal', difficulty: 'Medium', leetcodeLink: lc('binary-tree-level-order-traversal'), gfgLink: gfg('level-order-traversal') },
      ...
      },
      {
        title: 'Medium Problems',
        problems: [
          { id: 'bt13', name: 'Height of Binary Tree', difficulty: 'Easy', leetcodeLink: lc('maximum-depth-of-binary-tree'), gfgLink: gfg('height-of-binary-tree') },
          { id: 'bt14', name: 'Check if Balanced Binary Tree', difficulty: 'Easy', leetcodeLink: lc('balanced-binary-tree'), gfgLink: gfg('check-for-balanced-tree') },
          { id: 'bt15', name: 'Diameter of Binary Tree', difficulty: 'Easy', leetcodeLink: lc('diameter-of-binary-tree'), gfgLink: gfg('diameter-of-binary-tree') },
          { id: 'bt16', name: 'Maximum Path Sum', difficulty: 'Hard', leetcodeLink: lc('binary-tree-maximum-path-sum'), gfgLink: gfg('maximum-path-sum-from-any-node') },
          { id: 'bt17', name: 'Same Tree', difficulty: 'Easy', leetcodeLink: lc('same-tree'), gfgLink: gfg('determine-if-two-trees-are-identical') },
          { id: 'bt18', name: 'Zig Zag Traversal', difficulty: 'Medium', leetcodeLink: lc('binary-tree-zigzag-level-order-traversal'), gfgLink: gfg('zigzag-tree-traversal') },
          { id: 'bt19', name: 'Boundary Traversal', difficulty: 'Medium', gfgLink: gfg('boundary-traversal-of-binary-tree') },
          { id: 'bt20', name: 'Vertical Order Traversal', difficulty: 'Hard', leetcodeLink: lc('vertical-order-traversal-of-a-binary-tree'), gfgLink: gfg('print-a-binary-tree-in-vertical-order') },
          ...
          { id: 'bt23', name: 'Right/Left Side View', difficulty: 'Medium', leetcodeLink: lc('binary-tree-right-side-view'), gfgLink: gfg('left-view-of-binary-tree') },
          { id: 'bt24', name: 'Symmetric Binary Tree', difficulty: 'Easy', leetcodeLink: lc('symmetric-tree'), gfgLink: gfg('symmetric-tree') },
        ],
      },
      {
        title: 'Hard Problems',
        problems: [
          ...
          { id: 'bt26', name: 'Lowest Common Ancestor', difficulty: 'Medium', leetcodeLink: lc('lowest-common-ancestor-of-a-binary-tree'), gfgLink: gfg('lowest-common-ancestor-in-a-binary-tree') },
          { id: 'bt27', name: 'Maximum Width of Binary Tree', difficulty: 'Medium', leetcodeLink: lc('maximum-width-of-binary-tree'), gfgLink: gfg('maximum-width-of-tree') },
          { id: 'bt28', name: 'Children Sum Property', difficulty: 'Medium', articleLink: tuf('children-sum-property') },
          { id: 'bt29', name: 'All Nodes at Distance K', difficulty: 'Medium', leetcodeLink: lc('all-nodes-distance-k-in-binary-tree'), gfgLink: gfg('nodes-at-given-distance-in-binary-tree') },
          { id: 'bt30', name: 'Minimum Time to Burn Binary Tree', difficulty: 'Hard', gfgLink: gfg('burning-tree') },
          { id: 'bt31', name: 'Count Nodes in Complete Binary Tree', difficulty: 'Medium', leetcodeLink: lc('count-complete-tree-nodes'), gfgLink: gfg('count-number-of-nodes-in-a-complete-binary-tree') },
          { id: 'bt32', name: 'Requirements for Unique Binary Tree', difficulty: 'Medium', articleLink: tuf('unique-binary-tree-requirements') },
          { id: 'bt33', name: 'Construct BT from Inorder & Preorder', difficulty: 'Medium', leetcodeLink: lc('construct-binary-tree-from-preorder-and-inorder-traversal'), gfgLink: gfg('construct-tree-1') },
          { id: 'bt34', name: 'Construct BT from Inorder & Postorder', difficulty: 'Medium', leetcodeLink: lc('construct-binary-tree-from-inorder-and-postorder-traversal'), gfgLink: gfg('tree-from-postorder-and-inorder') },
          { id: 'bt35', name: 'Serialize and Deserialize BT', difficulty: 'Hard', leetcodeLink: lc('serialize-and-deserialize-binary-tree'), gfgLink: gfg('serialize-and-deserialize-a-binary-tree') },
          ...
          { id: 'bt38', name: 'Flatten Binary Tree to Linked List', difficulty: 'Medium', leetcodeLink: lc('flatten-binary-tree-to-linked-list'), gfgLink: gfg('flatten-binary-tree-to-linked-list') },
